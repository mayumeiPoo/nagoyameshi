...
private final ShopService shopService;
    ...
    public String edit(@PathVariable(name = "id") Integer id, Model model) {
        ...
        ShopEditForm shopEditForm = new ShopEditForm(shop.getId(), shop.getName(),null,shop.getDescription(), shop.getPrice(), shop.getCapacity(), shop.getPostalCode(), shop.getAddress(), shop.getPhoneNumber(), shop.getStation(), shop.getTimeStart(),shop.getTimeEnd(),shop.getCategory());
